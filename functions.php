 ...
 */
function orbisius_ct_teluro_child_theme_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_teluro_child_theme_parent_style';
    $parent_base_dir = 'teluro';
...
function teluro_child_theme_setup() {
    load_child_theme_textdomain( 'teluro-child-theme', get_stylesheet_directory() . '/languages' );
    load_child_theme_textdomain( 'teluro-child-theme', get_template_directory() . '/languages' );
}
add_action( 'wp_enqueue_scripts', 'orbisius_ct_teluro_child_theme_child_theme_enqueue_styles' );
